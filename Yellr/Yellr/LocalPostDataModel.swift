...
class LocalPostDataModel: NSObject {
    ...
    init( var lp_last_name : AnyObject?, var lp_language_code : AnyObject?, var lp_post_id : AnyObject?, var lp_verified_user : AnyObject?, var lp_post_datetime : AnyObject?, var lp_file_name : AnyObject?, var lp_media_text : AnyObject?, var lp_media_type_name : AnyObject?, var lp_preview_file_name : AnyObject?, var lp_media_caption : AnyObject?, var lp_first_name : AnyObject?, var lp_question_text : AnyObject?, var lp_is_up_vote : AnyObject?, var lp_down_vote_count : AnyObject?, var lp_has_voted : AnyObject?, var lp_language_name : AnyObject?, var lp_up_vote_count : AnyObject?) {
